document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function fetchProductDetails(productId) {
        try {
            ...
            console.log('Product details response:', data); // Debugging log
    ...
    async function displayProductDetails() {
        try {
            ...
            console.log('Product to display:', product); // Debugging log
  
            const productPrice = parseFloat(product.price);
            console.log('Product price:', productPrice, typeof productPrice); // Debugging log
  
            if (isNaN(productPrice)) throw new Error('Invalid product price');
            ...
            productDetailsSection.innerHTML = `
                ...
                <p>In Stock: ${product.total_quantity}</p>
    ...
    async function addToCart(productId) {
        ...
        try {
            ...
            if (data.success) {
                ...
                await displayProductDetails(); // Refresh product details to update stock quantity
            } else {
