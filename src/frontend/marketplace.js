document.addEventListener("DOMContentLoaded", () => {
  ...
  // Define home URLs based on user roles
  const homeUrls = {
  ...
  // Display account information and hide marketplace controls
  ...
  // Navigate to the previous page of products
  ...
  // Filter products based on the selected price range and display them
  ...
  // Hide marketplace-specific controls
  ...
  // Initialize the marketplace and update cart item count on page load
  init();
  updateCartItemCount();
});
